...
!(function (a) {
    ...
    (c.DEFAULTS = { words: {}, ranges: {}, color: "#ffff0025", caseSensitive: !0, wordsOnly: !1, resizable: !1, resizableOptions: {}, id: "", debug: !1 }),
        ...
        (c.prototype.destroy = function () {
            this.disable(),
                d.cloneCss(this.$container, this.$el, ["background-image", "background-color", "background-position", "background-repeat", "background-origin", "background-clip", "background-size", "background-attachment"]),
        ...
        (c.prototype.setOptions = function (b) {
            "object" != typeof b ||
                ...
                a.isEmptyObject(this.settings.words)
                    ? a.isEmptyObject(this.settings.ranges) || ((this.settings.words = {}), (this.settings.ranges = d.cleanRanges(this.settings.ranges, this.settings.color)))
                    : ((this.settings.words = d.cleanWords(this.settings.words, this.settings.color)), (this.settings.ranges = {})),
        ...
        (c.prototype.updateCss = function () {
            d.cloneCss(this.$el, this.$main, ["float", "vertical-align"]),
                ...
                d.cloneCss(this.$el, this.$highlighter, ["font-size", "font-family", "font-style", "font-weight", "font-variant", "font-stretch", "vertical-align", "word-spacing", "text-align", "letter-spacing", "text-rendering", "color"]),
                this.$el.css({ 
					background: "none", 
        ...
        (c.prototype.updateSizePosition = function (a) {
            a && (this.$main.css({ width: this.$el.outerWidth(!0), height: this.$el.outerHeight(!0) }), this.$container.css({ width: this.$el.width(), height: this.$el.height() }));
            var b,
                c = 0;
            this.isInput
                ? (b = 99999)
                : (("scroll" == this.$el.css("overflow") ||
                      ...
                      ("hidden" != this.$el.css("overflow") && "hidden" != this.$el.css("overflow-y") && this.$el[0].clientHeight < this.$el[0].scrollHeight)) &&
                      (c = this.scrollbarWidth),
                  (b = this.$el.width() - c)),
                this.$highlighter.css({ width: b, height: this.$el.height() + this.$el.scrollTop(), top: -this.$el.scrollTop(), left: -this.$el.scrollLeft() });
        });
    var d = function () {};
                ...
                if (a.isArray(h)) e.push({ color: d, start: h[0], end: h[1] });
                    ...
                    for (var i = 0, j = h.ranges.length; j > i; i++)
                        a.isArray(h.ranges[i])
                            ? e.push({ color: h.color, class: h["class"], start: h.ranges[i][0], end: h.ranges[i][1] })
